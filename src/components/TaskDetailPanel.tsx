...
export function TaskDetailPanel({ task, projectId, projectName, onStatusChange, onClickTask }: TaskDetailPanelProps) {
      ...
      <div className="shrink-0 p-5 pb-4 border-b border-border-subtle space-y-3">
        <div className="flex items-center gap-2">
          {isQueued ? (
            ...
            <span className="flex items-center gap-1.5 text-xs text-gold font-medium uppercase tracking-wide">
              <ClockIcon className="w-3 h-3" />
              Awaiting review
            </span>
          ) : task.status === 'done' ? (
            <span className="flex items-center gap-1.5 text-xs text-patina font-medium uppercase tracking-wide">
        ...
        <div className="flex items-center gap-3 text-[11px] text-bronze-500 dark:text-zinc-500">
          ...
          {task.priority && (
            <>
              <span className="text-bronze-400 dark:text-zinc-700">&middot;</span>
        ...
        {task.branch && (
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1 text-xs font-mono px-1.5 py-0.5 rounded border border-bronze-400/50 bg-bronze-200/60 text-bronze-700 dark:border-zinc-700/50 dark:bg-zinc-800/60 dark:text-zinc-300">
