...
import { TabOption, Project } from '../types';
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative px-4 py-1.5 text-sm font-medium rounded-md z-10 ${isActive ? 'text-zinc-100' : 'text-zinc-500 hover:text-zinc-300'}`}>
