...
import { GlobeIcon, MonitorIcon, WifiOffIcon } from 'lucide-react';
  ...
  return (
    <div className="flex-1 h-full flex flex-col bg-zinc-950">
      ...
      <div className="flex-1 bg-white flex items-center justify-center relative overflow-hidden">
        {/* Mock Iframe Content Placeholder */}
        <div className="absolute inset-0 bg-zinc-100 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-pulse w-32 h-32 bg-zinc-200 rounded-full mx-auto mb-4"></div>
            <div className="h-4 w-48 bg-zinc-200 rounded mx-auto mb-2"></div>
            <div className="h-4 w-32 bg-zinc-200 rounded mx-auto"></div>
            <p className="mt-8 text-zinc-400 text-sm font-mono">
              Preview Mode: {project.liveUrl}
            </p>
          </div>
        </div>
      </div>
